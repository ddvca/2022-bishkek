...
fsm_asic_dir=../lecture/03_asic_openlane/src/OpenLane/designs/snail_moore_fsm/src
...
zip -r $pwd/${root_name}_$(date '+%Y%m%d_%H%M%S').zip $root_name/{day,lecture,README,LICENSE}* \
